package com.nttdata.credit.product.management.ms.configuration.mongodb;
...
@Configuration
@EnableReactiveMongoRepositories(basePackages = "com.nttdata.credit.product.management.ms.repository")
public class MongoConnection extends AbstractReactiveMongoConfiguration{
    ...
    public Collection<String> getMappingBasePackages() {
       return Collections.singleton("com.nttdata.credit.product.management.ms");
    }
